-- CellWatcher: replace battery_can_mapping.signal_notes with a proper battery_can_signal child
-- table (MariaDB)
--
...
--
-- Run this once against the cellwatcher database (after create_battery_type.sql):
--   mysql -h 192.168.0.224 -u <admin-user> -p cellwatcher < alter_battery_can_mapping_add_signals.sql
