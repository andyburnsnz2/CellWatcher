-- CellWatcher: individual cell voltage readings (MariaDB)
--
...
--
-- Run this once against the cellwatcher database, after create_battery_cell_snapshot.sql:
--   mysql -h <host> -u CellWatcher -p cellwatcher < create_battery_cell_reading.sql
