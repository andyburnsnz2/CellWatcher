-- CellWatcher: battery types + their CAN ID mappings, imported from the Battery-Emulator
...
--   mysql -h 192.168.0.224 -u <admin-user> -p cellwatcher < create_battery_type.sql
