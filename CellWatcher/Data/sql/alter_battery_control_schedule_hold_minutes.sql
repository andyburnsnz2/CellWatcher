-- CellWatcher: add hold_at_target_minutes to battery_control_schedule (MariaDB)
--
...
--
--   mysql -h 192.168.0.224 -u <admin-user> -p cellwatcher < alter_battery_control_schedule_hold_minutes.sql
