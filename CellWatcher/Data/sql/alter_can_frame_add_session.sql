-- CellWatcher: tag can_frame rows with the logging session they belong to (MariaDB)
--
...
--
-- Run this once against the cellwatcher database (after create_can_session.sql):
--   mysql -h 192.168.0.224 -u <admin-user> -p cellwatcher < alter_can_frame_add_session.sql
