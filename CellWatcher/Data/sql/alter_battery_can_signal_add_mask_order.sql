-- CellWatcher: record mask/shift operation order on battery_can_signal (MariaDB)
--
...
-- imported batteries.
--
-- Run this once against the cellwatcher database (after alter_battery_can_signal_add_decode_fields.sql):
--   mysql -h 192.168.0.224 -u <admin-user> -p cellwatcher < alter_battery_can_signal_add_mask_order.sql
