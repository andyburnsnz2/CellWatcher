-- CellWatcher: add token-usage / estimated-cost tracking to battery_ai_analysis
--
-- Run once against an existing database that already has battery_ai_analysis:
--   mysql -h 192.168.0.224 -u CellWatcher -p cellwatcher < alter_battery_ai_analysis_add_cost.sql
