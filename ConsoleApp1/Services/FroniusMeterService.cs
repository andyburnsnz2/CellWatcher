...
//
// This is phase 1 of folding the standalone Python fake-meter into BatteryEMU: a straight port
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var optionsBuilder = new MqttClientOptionsBuilder()
                    ...
                    .WithClientId($"BatteryEMU-FroniusMeter-{Environment.MachineName}");
