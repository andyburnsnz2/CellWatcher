-- BatteryEMU: generic application error log (MariaDB)
--
...
--   mysql -h 192.168.0.224 -u BatteryEMU -p batteryemu < create_application_error.sql
...
(
    ...
    -- (e.g. BatteryEMU.Services.MqttMessageProcessor)
