-- BatteryEMU: record what was actually sent to the AI alongside its response
--
...
--   mysql -h 192.168.0.224 -u BatteryEMU -p batteryemu < alter_battery_ai_analysis_add_prompts.sql
