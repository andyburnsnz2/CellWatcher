-- BatteryEMU: add charge_discharge_power_watts to battery_control_schedule (MariaDB)
--
...
--
--   mysql -h 192.168.0.224 -u <admin-user> -p batteryemu < alter_battery_control_schedule_power_watts.sql
