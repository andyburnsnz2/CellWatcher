-- BatteryEMU: migrate battery_control_schedule from `enabled` to `activation_mode` (MariaDB)
--
...
--
--   mysql -h 192.168.0.224 -u <admin-user> -p batteryemu < alter_battery_control_schedule_activation_mode.sql
