-- BatteryEMU: structured decode fields on battery_can_signal (MariaDB)
--
...
--
-- Run this once against the batteryemu database (after alter_battery_can_mapping_add_signals.sql):
--   mysql -h 192.168.0.224 -u <admin-user> -p batteryemu < alter_battery_can_signal_add_decode_fields.sql
