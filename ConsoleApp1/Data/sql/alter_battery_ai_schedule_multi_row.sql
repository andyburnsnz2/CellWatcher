-- BatteryEMU: convert battery_ai_schedule from a single settings row into a
...
--   mysql -h 192.168.0.224 -u BatteryEMU -p batteryemu < alter_battery_ai_schedule_multi_row.sql
