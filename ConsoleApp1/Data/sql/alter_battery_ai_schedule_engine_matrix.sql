-- BatteryEMU: replace battery_ai_schedule.report_type with an explicit
-- per-engine/per-report matrix, and widen frequency to fit 'fortnightly'.
--
-- Run this once against the batteryemu database:
--   mysql -h 192.168.0.224 -u BatteryEMU -p batteryemu < alter_battery_ai_schedule_engine_matrix.sql
